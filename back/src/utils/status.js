 ...
 * must also take care about the caching-related headers that are sent along
 * with this response, as these temporary condition responses should usually not
 * be cached.  */
export const STATUS_503_SERVICEUNAVAILABLE = 503;
