 ...
 */
module.exports.STATUS_403_FORBIDDEN = 403;
 ...
 */
module.exports.STATUS_404_NOTFOUND = 404;

/** The request method is known by the server but is not supported by the
 * target resource.
 * For example, an API may not allow calling `DELETE` to remove a resource.
 */
module.exports.STATUS_405_METHODNOTALLOWED = 405;

/**The server has encountered a situation it does not know how to handle.
 */
module.exports.STATUS_500_INTERNALSERVERERROR = 500;
 ...
 */
module.exports.STATUS_501_NOTIMPLEMENTED = 501;
